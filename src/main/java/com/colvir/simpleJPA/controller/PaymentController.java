...
import com.colvir.simpleJPA.service.PaymentService;
...
//    private EmployeeRepository employeeRepository;
    ...
    public List<PaymentDto> getAllPaymentsByEmployeeId(@PathVariable Integer employeeId)  {

        return paymentService.getAllPaymentsByEmployeeId(employeeId);
    }
